                ...
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-28">
                    ...
                    <div className="flex-1 space-y-14">
                        ...
                        >
                            ...
                            <h3 className="text-4xl sm:text-5xl md:text-[5.5rem] font-heading font-black text-navy mb-6 sm:mb-8 tracking-[-0.03em] leading-[0.9]">
                                MEASURING<br />
                                <span className="text-navy/15 font-light tracking-tight">LIMITLESS.</span>
                            </h3>
                            <p className="text-base sm:text-lg text-slate-400 font-medium tracking-tight leading-relaxed max-w-lg">
                    ...
                    >
                        {/* Navy premium card */}
                        <div className="bg-navy rounded-[2rem] sm:rounded-[3rem] overflow-hidden border border-white/[0.07] shadow-[0_40px_100px_rgba(4,14,33,0.35),0_8px_32px_rgba(4,14,33,0.15)] relative group">
                            {/* Top accent line */}
